...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('tipo_arquivo', sa.Enum('PDF', 'XML', name='tipo_arquivo_enum'), nullable=False),
        sa.Column('tipo_movimentacao', sa.Enum('ENTRADA', 'SAIDA', name='tipo_mov_arquivo_enum'), nullable=False),
    ...
    # Adicionar colunas de reversão em movimentacoes_estoque
    ...
    # Criar foreign keys e índices para reversão
