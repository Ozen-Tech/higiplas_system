#!/usr/bin/env python3
"""
Script para aplicar as mudanças de reversão de movimentações e arquivos processados.
Execute este script para adicionar as novas colunas e tabelas ao banco de dados.
"""
...
if __name__ == "__main__":
    logger.info("=" * 60)
    logger.info("Script de Migração - Reversão de Movimentações")
    logger.info("=" * 60)
